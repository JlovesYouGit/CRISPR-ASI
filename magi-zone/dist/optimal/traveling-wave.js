 ...
 */
export function travelingWaveFromState(waveState, userPosition = [0, 0, 0]) {
 ...
 */
export function userLocationFromTravelingWave(wave, safetyRadius = DEFAULT_SAFETY_RADIUS) {
    return {
 ...
 */
export function resolveUserLocation(waveState, explicitPosition, safetyRadius = DEFAULT_SAFETY_RADIUS) {
