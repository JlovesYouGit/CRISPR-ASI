...
const DANGER_OVERRIDE_TIER = 4; // high advanced
/**
 ...
 */
export function resolveTier(intent, defaultTier = 2) {
 ...
 */
export function isPermittedForUser(intent, hasEnoughMana, calculusPermitted) {
    if (!hasEnoughMana || !calculusPermitted)
        return false;
